  ...
  fetch("products.json")
    ...
    .then(products => {
      ...
      if (item) {
        ...
        // Show success message below the buttons
        showSuccessMessage(`${item.name} added to cart!`);
      } else {
        // If the product was not found, show error message
        showSuccessMessage("Invalid QR/Product not found!", true);
      }
    });
}
...
function showSuccessMessage(message, isError = false) {
  ...
  msgDiv.style.color = isError ? "#e11d48" : "#22c55e";
